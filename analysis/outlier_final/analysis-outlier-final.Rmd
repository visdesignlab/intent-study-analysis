...
# df_all <- read.csv("../../results/pilot/CSV/TidyR.csv")
# dfp_all <- read.csv("../../results/pilot/CSV/participantInfoTidyR.csv")
df <- read.csv("../../results/outlier/CSV/TidyR.csv")
dfp <- read.csv("../../results/outlier/CSV/participantInfoTidyR.csv")

# df <- rbind(df_all, df_out)
# dfp <- rbind(dfp_out, dfp_out)
