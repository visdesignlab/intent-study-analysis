...
mcb$userDriven <- ifelse(mcb$PANEL==1, "manual", "supported")
...
#     geom_point( shape=1 , aes(colour=taskDifficulty)) +
#     stat_summary(fun.data = "mean_cl_boot", colour = "red", size = 0.5, alpha=0.5) +
#   coord_flip() +
#     facet_grid(. ~ userDriven)
# 
